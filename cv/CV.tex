...
\programming{{TypeScript $\textbullet$ HTML $\textbullet$ CSS$\textbullet$ SQL / 3}, {Haskell $\textbullet$ Scala / 4.5}, {Rust $\textbullet$ C++ $\textbullet$ C $\textbullet$ Python / 5}, {Java $\textbullet$ Kotlin/ 5.5}}
